...
void GameStatObserver::Update() {
	_gamestatsubject->deriveNumberOfCountriesOwned();
	_gamestatsubject->deriveTotalNumberofArmiesOwned();
	_gamestatsubject->deriveTotalNumberOfCardsOwned();
...
void GameStatObserver::update(std::string str, std::string playername, std::string phasename){};

void GameStatObserver::printself(){};