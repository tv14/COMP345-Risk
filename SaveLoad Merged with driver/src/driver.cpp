...
void addMapSettings(MapManager* manager){
	...
	manager->setMapFileName(map_settings[0]);
...
MapManager* mapCreationRun() {
	bool startGame = false;

	cout << "Map Manager : " << endl << endl;
...
void driver::run() {
	...
	MapManager* mapmanager =  mapCreationRun();
	...
	*/
	...
	// map loading
	string filename = "";
	//cout << "\nPlease specify which map to load for this match: (This will have to be a valid map)";
